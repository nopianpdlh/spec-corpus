...
Treat this skill as a React/Next.js/Vercel-specific performance appendix. It complements the reusable frontend baseline, but it is not the canonical owner for framework-agnostic frontend rules.
